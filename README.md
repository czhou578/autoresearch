...
Hi, have a look at program.md and let's kick off a new experiment using 2 worker agents! The worker agents should run their trials in parallel. Let's do the setup first!
